        ...
        if ((d = this._getRange()) && d.collapsed) {
          ...
          if (/firefox/i.test(navigator.userAgent)) {
            ...
            (c = d.startOffset - 1) >= 0
              ? ((o = d.cloneRange()),
                ...
                t(o.cloneContents()).contents().last().is('.atwho-inserted') &&
                  ((a = t(d.startContainer).contents().get(c)),
                  this._setRange('after', t(a).contents().last())))
              : e.which === i.LEFT &&
          ...
          if (
            (r.length > 0 &&
              ...
              (r.empty().html(f).attr('data-atwho-at-query', null),
                ...
                r.text().indexOf(this.at) >= 0 &&
                  (this._movingEvent(e) && r.hasClass('atwho-inserted')
                    ...
                    : !1 !==
                      ...
                      this._setRange(
                        'after',
                        this._unwrap(r.text(r.text()).contents().first())
                      )),
                null)
        }
      }),
